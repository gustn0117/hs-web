      ...
      <div className="max-w-[800px] mx-auto px-6">
        ...
        <div className="mt-10 fade-up" style={{ transitionDelay: "200ms" }}>
          <div className="bg-white rounded-2xl border border-gray-100 p-6 flex flex-col sm:flex-row items-center gap-4 shadow-sm">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--color-primary)] to-emerald-400 flex items-center justify-center text-white shadow-md shrink-0">
            ...
            <Link
              href="/contact"
              className="btn-ripple px-6 py-2.5 rounded-xl font-semibold text-white bg-gradient-to-r from-[var(--color-primary)] to-emerald-400 no-underline text-[0.9rem] hover:shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 shrink-0"
            >
              무료 상담 신청
            </Link>
          </div>
