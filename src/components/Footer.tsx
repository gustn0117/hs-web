          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <form onSubmit={handleNewsletter} className="flex gap-2 max-w-[300px]">
                ...
                <button
                  type="submit"
                  className="btn-ripple px-4 py-2 bg-gradient-to-r from-[var(--color-primary)] to-blue-600 text-white rounded-lg text-[0.85rem] font-semibold border-none cursor-pointer hover:shadow-md hover:shadow-blue-500/20 transition-all"
                >
                  구독
                </button>
              </form>
