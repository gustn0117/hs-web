      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          ...
          <div className="hidden lg:block absolute top-[56px] left-[15%] right-[15%] h-[2px]">
            ...
            <div
              className={`absolute top-0 left-0 h-full bg-gradient-to-r from-emerald-400 via-violet-400 to-amber-400 rounded-full ${visible ? 'animate-[draw-line_2s_ease-out_forwards]' : 'w-0'}`}
            />
          </div>
