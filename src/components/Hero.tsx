...
export default function Hero() {
  ...
  return (
    <section ref={sectionRef} className="min-h-screen bg-gradient-to-br from-white via-emerald-50/30 to-indigo-50/20 flex items-center pt-[72px] relative overflow-hidden">
      ...
      <div className="absolute top-[25%] right-[6%] w-14 h-14 border border-emerald-400/10 rounded-lg animate-rotate-slow pointer-events-none" />
      ...
      <div className="absolute top-[70%] right-[18%] w-16 h-[2px] bg-gradient-to-r from-transparent via-emerald-300/20 to-transparent pointer-events-none" />

      <div className="max-w-[1200px] mx-auto px-6 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="text-center lg:text-left">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-emerald-200/60 px-4 py-2 rounded-full text-[var(--color-primary)] text-[0.85rem] font-semibold mb-6 shadow-sm shadow-emerald-100/50">
            ...
            <div className="flex gap-4 flex-wrap justify-center lg:justify-start">
              <Link
                href="/contact"
                className="btn-ripple group inline-flex items-center gap-2 px-8 py-[14px] rounded-xl font-semibold text-white bg-gradient-to-r from-[var(--color-primary)] to-emerald-600 hover:shadow-xl hover:shadow-emerald-500/25 transition-all duration-300 no-underline hover:scale-[1.02]"
              >
                무료 상담 받기
            ...
            <div className="w-full max-w-[500px] bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-2xl shadow-emerald-500/10 animate-float" style={{ animationDuration: "5s" }}>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    { color: "bg-emerald-100", border: "border-emerald-50" },
