    ...
    <section className="relative overflow-hidden py-24 bg-[var(--color-dark)]">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10 text-center">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <Link
            href="/contact"
            className="group inline-flex items-center gap-2 bg-gradient-to-r from-[var(--color-primary)] to-emerald-600 text-white px-9 py-4 rounded-xl font-bold text-[1.05rem] hover:shadow-xl hover:shadow-emerald-500/25 hover:scale-[1.02] transition-all duration-300 no-underline"
          >
            무료 상담 신청
