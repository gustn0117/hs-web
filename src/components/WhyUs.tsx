      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="fade-left">
            ...
            {/* Philosophy quote */}
            <div className="border-l-[3px] border-[var(--color-primary)] pl-4 mb-8 bg-blue-50/50 py-3 pr-4 rounded-r-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {reasons.map((r, i) => {
              ...
              return (
                ...
                >
                  <span className="absolute -top-2 -right-1 text-[4rem] font-black text-gray-50 group-hover:text-blue-50 transition-colors duration-500 select-none leading-none">
                    {num}
                  </span>
