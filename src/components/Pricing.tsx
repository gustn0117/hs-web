          ...
          {plans.map((p, i) => (
            <div
              ...
              className={`fade-scale rounded-2xl transition-all duration-300 relative overflow-hidden ${
                p.popular
                  ? "lg:scale-105 shadow-2xl shadow-blue-500/15"
              ...
              {p.popular ? (
                <div className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-dark-2)] p-9 relative">
                  ...
                  <div className="relative z-10">
                    <span className="shimmer-badge bg-gradient-to-r from-[var(--color-primary)] to-blue-400 text-white px-4 py-1 rounded-full text-[0.75rem] font-semibold shadow-lg shadow-blue-500/30 relative overflow-hidden inline-block mb-5">
                      가장 인기
                    </span>
                    ...
                    {/* Audience */}
                    <div className="text-blue-400/80 text-[0.78rem] font-medium mb-4">
                      추천: {p.audience}
                    </div>
                    {/* Guarantee */}
                    {"guarantee" in p && p.guarantee && (
                      <div className="inline-flex items-center gap-1.5 bg-blue-500/15 border border-blue-400/20 text-blue-300 text-[0.75rem] font-semibold px-3 py-1.5 rounded-full mb-6">
                    ...
                    <Link
                      href="/contact"
                      className="btn-ripple block w-full text-center py-4 rounded-xl font-semibold no-underline transition-all duration-300 bg-gradient-to-r from-[var(--color-primary)] to-blue-400 text-white hover:shadow-xl hover:shadow-blue-500/30 hover:scale-[1.02] text-[0.95rem]"
                    >
                      상담 신청
                    </Link>
                  </div>
                ...
                <div className="p-9">
                  ...
                  <Link
                    href="/contact"
                    className="btn-ripple block w-full text-center py-3.5 rounded-xl font-semibold no-underline transition-all duration-300 border-2 border-gray-200 text-[var(--color-dark)] hover:border-[var(--color-primary)] hover:text-[var(--color-primary)] hover:bg-blue-50/50"
                  >
