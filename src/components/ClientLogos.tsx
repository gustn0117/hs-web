...
function LogoItem({ name, weight }: { name: string; weight: string }) {
  return (
    <div className="mx-4 px-7 py-3.5 bg-gray-50/80 border border-gray-100 rounded-xl inline-flex items-center gap-3 hover:bg-white hover:border-blue-200 hover:shadow-lg hover:shadow-blue-500/8 hover:scale-105 transition-all duration-300 cursor-default select-none group">
