...
export default function Contact() {
  ...
  return (
    <section className="pt-32 pb-24 relative overflow-hidden" ref={ref}>
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-white via-blue-50/20 to-blue-50/10 pointer-events-none" />
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        <div className="text-center mb-14 fade-up">
          ...
          {/* Response time badge */}
          <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 text-blue-700 px-4 py-2 rounded-full text-[0.82rem] font-semibold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="fade-left">
            ...
            <div className="space-y-4 mb-8">
              {contactItems.map((item) => (
                ...
                >
                  <div className="w-10 h-10 bg-gradient-to-br from-[var(--color-primary)] to-blue-400 text-white rounded-lg flex items-center justify-center shrink-0 shadow-md shadow-blue-500/15 group-hover:scale-110 transition-transform duration-300">
                    {item.icon}
                  </div>
                  <div>
          ...
          >
            ...
            <button
              type="submit"
              disabled={sending}
              className="btn-ripple w-full py-3.5 bg-gradient-to-r from-[var(--color-primary)] to-blue-600 text-white border-none rounded-xl text-base font-bold cursor-pointer transition-all hover:shadow-lg hover:shadow-blue-500/25 hover:scale-[1.01] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {sending ? (
                <>
