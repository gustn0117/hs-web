...
const PRICE_REASONS = [
  ...
  },
  {
    n: "02",
    title: "자체 인프라 운영",
    desc: "외부 서버 임대 없이 직접 운영하는 서버에 배포합니다. 호스팅 마진 없이 원가 수준으로 제공합니다.",
    impact: "호스팅 원가 수준 제공",
  },
  {
    n: "03",
  ...
  },
  {
    n: "04",
    title: "솔직한 가격",
    desc: "월 운영비·관리비 명목의 보수적 청구가 없습니다. 결과물 인도 시 정산이 끝나며, 콘텐츠 수정은 평생 무료입니다.",
...
const FAQS = [
  {
    cat: "가격",
    q: "어떻게 그렇게 저렴한 가격이 가능한가요?",
    a: "1인 전담 구조와 자체 인프라 덕분입니다. 기획·디자인·개발을 직접 진행해 인건비 마진이 없고, 사무실·영업·광고 같은 고정비를 운영하지 않으며, 호스팅도 자체 서버로 처리합니다. 그 절감분을 가격에 반영해, 일반 업체와 동등한 결과물을 더 합리적인 비용으로 제공합니다.",
  },
  {
    cat: "가격",
    q: "정말 운영비가 0원인가요? 숨겨진 비용은 없나요?",
    a: "운영비·관리비 명목의 정기 청구는 없습니다. 결과물 인도 시 정산이 끝나며, 콘텐츠 수정(텍스트·이미지)은 평생 무료로 지원합니다. 단 도메인 갱신비와 호스팅 비용은 실비로 발생하며, 모두 시중 최저가 수준입니다.",
  },
  {
    cat: "가격",
    q: "견적 차이가 큰데, 결과물 품질도 차이가 클까요?",
    a: "외관과 기능만 봐서는 거의 차이가 없습니다. 오히려 자체 코딩으로 만든 사이트가 속도·SEO·보안 면에서 더 우수한 경우가 많습니다. 견적 차이의 본질은 결과물 자체가 아니라 비용 구조 차이입니다(인건비·사무실·영업·광고비 등). 의심되시면 포트폴리오에서 실제 라이브 작업물을 확인해보시거나, 다른 업체 견적과 직접 비교해보시기 바랍니다.",
  },
  {
    cat: "자체 코딩",
...
const HERO_PROOFS = [
  { v: "1인 전담", l: "기획·디자인·개발 직접" },
  { v: "운영비 0원", l: "관리비 정기 청구 없음" },
