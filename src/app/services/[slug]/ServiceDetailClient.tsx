  ...
  return (
    <PageShell
      ...
      actions={
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto">
          <Link href="/contact" className="p-btn p-btn-dark w-full sm:w-auto justify-center">
            무료 상담 신청
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
            </svg>
          </Link>
          <a href="tel:010-3319-2509" className="p-btn tnum hidden sm:inline-flex">010-3319-2509</a>
        </div>
      }
    ...
    >
      ...
      <Section overline="OVERVIEW" title="서비스 개요">
        <div className="p-card p-5 sm:p-7 md:p-9">
          ...
          <div className="p-card overflow-hidden">
            {service.faqs.map((faq, i) => (
              <details key={i} className="group border-b border-[var(--c-line)] last:border-b-0">
                ...
                <div className="px-6 pb-6 sm:pl-[76px] text-[13.5px] text-[var(--c-sub)] leading-[1.8] whitespace-pre-line">
                  {faq.a}
                </div>
              </details>
            ))}
    ...
    <div className="relative">
      ...
      <div className="relative rounded-[14px] md:rounded-[16px] border border-[var(--c-line)] bg-[#1a1d26] overflow-hidden">
        ...
        <div className="relative aspect-[4/3] sm:aspect-[16/9] md:aspect-[21/9] flex items-center justify-center overflow-hidden">
          ...
          {/* Glow orbs */}
          <div
            className="absolute -top-20 -right-16 w-[200px] h-[200px] sm:w-[320px] sm:h-[320px] rounded-full blur-3xl opacity-20 sm:opacity-30"
