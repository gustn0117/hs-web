...
const faqs = [
  ...
  { q: "SEO(검색엔진 최적화)도 포함되나요?", a: "내부 코드 단의 SEO 최적화(메타 태그·sitemap·구조화 데이터 등)는 모든 플랜에 기본 포함됩니다. 다만 Google·Naver 등 플랫폼별 사이트 등록·인증·인덱싱 요청 같은 본격적인 SEO 작업은 플랫폼당 50,000원의 별도 비용이 발생합니다. 또한 상위 노출이나 특정 키워드 노출 같은 부분은 SEO 영역이 아닌 마케팅 영역이라 별도 마케팅 업체를 통해 진행하셔야 합니다. 자세한 내용은 검색엔진 최적화 안내 페이지를 참고해주세요." },
  { q: "검색엔진에 등록하면 바로 검색 결과에 뜨나요?", a: "아니요, 즉시 뜨지 않습니다. 사이트맵 제출과 인덱싱 요청은 검색엔진에 '이 사이트를 봐주세요'라는 신청일 뿐, 실제 색인은 검색엔진 알고리즘이 결정합니다. 보통 1~2주가 평균이며 사이트 규모·도메인 신뢰도에 따라 빠르면 며칠, 늦으면 한 달 이상 걸리기도 합니다." },
