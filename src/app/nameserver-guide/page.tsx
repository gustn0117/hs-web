        ...
        >
          <div id={r.slug} className="scroll-mt-20 grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-3">
            ...
            <div className="p-6 md:p-7 rounded-[16px] border border-[var(--c-line)] bg-white">
              <div className="flex items-center justify-between gap-3 mb-5 pb-5 border-b border-[var(--c-line)]">
                <div>
                  <p className="text-[11px] font-bold tracking-[0.14em] uppercase text-[var(--c-main)] mb-1.5">메뉴 경로</p>
                  <p className="text-[13px] text-[var(--c-text-2)] leading-[1.6]">{r.menuPath}</p>
                </div>
                <a
                  href={r.websiteUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="shrink-0 inline-flex items-center gap-1.5 h-9 px-3.5 rounded-[8px] bg-[var(--c-bg-1)] border border-[var(--c-line)] text-[12px] font-semibold text-[var(--c-text-2)] no-underline hover:bg-[var(--c-bg-2)] hover:border-[var(--c-text)] transition-colors"
                >
                  사이트
