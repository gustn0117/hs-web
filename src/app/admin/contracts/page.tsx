    ...
    <div className="min-h-screen bg-[var(--color-light)]">
      ...
      {detail && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm p-4" onClick={() => setDetail(null)}>
          <div className="bg-white shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-6 py-5 space-y-5">
              ...
              <div>
                ...
                {detail.status === "signed" && detail.client_signature ? (
                  ...
                  <div className="border border-amber-200 bg-amber-50/50 p-4 flex items-center gap-3">
              ...
              {detail.status === "signed" && (
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="w-full py-2.5 bg-white border border-emerald-200 text-emerald-700 font-semibold text-sm hover:bg-emerald-50 transition-colors cursor-pointer"
                  >
                    계약서 보기
                  </button>
                  <button
                    onClick={() => handlePrintContract(detail)}
                    className="w-full py-2.5 bg-[var(--color-dark)] text-white font-semibold text-sm hover:opacity-90 transition-opacity cursor-pointer border-none inline-flex items-center justify-center gap-1.5"
                  >
