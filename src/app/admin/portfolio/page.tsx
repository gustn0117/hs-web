      ...
      <div className="max-w-[1200px] mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[var(--color-primary)] to-emerald-600 text-white rounded-xl text-sm font-semibold no-underline hover:shadow-lg hover:shadow-emerald-500/25 transition-all"
          >
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {items.map((item) => (
              ...
              >
                {/* Thumbnail */}
                <div className="h-36 bg-gradient-to-br from-emerald-900/30 to-indigo-900/30 relative">
                  {item.thumbnail ? (
