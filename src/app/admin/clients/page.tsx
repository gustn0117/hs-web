                  ...
                  <button
                    ...
                    className={`px-4 py-1.5 text-sm rounded-lg cursor-pointer transition-all border-none ${
                      filter === key
                        ...
                        : "bg-transparent text-[var(--color-gray)] hover:bg-white"
                    }`}
                  >
                    {label}
                  </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {filtered.map((client) => (
              <div
                ...
                className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-md hover:border-gray-300 transition-all cursor-pointer group shadow-sm"
              >
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    {/* Avatar */}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <h3 className="text-[var(--color-dark)] font-semibold text-sm truncate">
                          {client.name}
                        </h3>
                        <span
                      ...
                      <p className="text-[var(--color-gray)] text-xs truncate mt-0.5">
                        @{client.username}
                      </p>
                    </div>
                  </div>
                ...
                <div className="px-6 pb-4 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-xs text-gray-400 hover:text-red-500 transition-all cursor-pointer bg-transparent border-none p-1 opacity-0 group-hover:opacity-100"
                  >
                    삭제
                  </button>
                </div>
