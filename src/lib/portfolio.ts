...
const SEED_DATA: PortfolioItem[] = [
  ...
  },
  {
    ...
    client: "교육 기업",
    date: "2025-03",
    description: "강의 콘텐츠와 수강생을 관리하는 맞춤형 CMS. 비개발자도 손쉽게 콘텐츠를 운영할 수 있습니다.",
    content: "교육 기업을 위한 맞춤형 콘텐츠 관리 시스템(CMS)을 개발했습니다.\n\n강의 등록, 카테고리 관리, 수강생 관리, 진도율 추적 등의 기능을 포함하며, 관리자가 코드 없이도 콘텐츠를 자유롭게 추가·수정·삭제할 수 있는 직관적인 관리 패널을 제공합니다.\n\n역할 기반 권한 시스템을 적용하여 관리자, 강사, 수강생 각각에게 적절한 접근 권한을 부여했으며, 대시보드를 통해 수강 현황과 매출 데이터를 한눈에 파악할 수 있습니다.",
    thumbnail: "",
    images: [],
  ...
  },
  {
    ...
    client: "제조 기업",
    date: "2025-05",
    description: "생산관리, 재고관리, 인사관리를 통합한 기업 맞춤형 ERP 시스템을 구축했습니다.",
    content: "중소 제조 기업의 업무 효율을 극대화하기 위한 통합 ERP 시스템을 개발했습니다.\n\n생산 계획 수립, 자재 소요량 산출, 실시간 재고 추적, 출퇴근 관리, 급여 정산 등 기업 운영에 필수적인 기능을 하나의 플랫폼에서 관리할 수 있도록 설계했습니다.\n\n기존 엑셀 기반 업무를 시스템화하여 데이터 정확성을 높이고, 실시간 대시보드를 통해 경영진이 핵심 지표를 즉시 확인할 수 있도록 했습니다. 모바일 앱도 함께 제공하여 현장에서도 실시간으로 업무를 처리할 수 있습니다.",
    thumbnail: "",
    images: [],
